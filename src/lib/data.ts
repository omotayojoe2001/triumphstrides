import { Product, Service, Track, CurrencyConfig } from './types';
...
export const products: Product[] = [
  {
    ...
    images: ['/products/dehydratedbitterleaf.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/dehydratedsourspop.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/dehydratedugu.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/dehydrateduziza.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/ijebugarri.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/grindedcrayfish.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/organicwheatflour.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/palmoil(small).jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/peppersoupspice.jpg'],
    variants: [
  ...
  },
  {
    ...
    images: ['/products/plantainflour.jpg'],
    variants: [
  ...
  },
  {
    ...
    category: 'Leaves',
    description: 'Premium quality dried hibiscus flowers (Zobo), rich in antioxidants and vitamin C.',
    usedFor: 'Perfect for making refreshing Zobo drink (hibiscus tea). Can be served hot or cold with natural sweeteners and spices.',
    images: ['/products/driedzobo.jpg'],
    variants: [
      { id: 'zobo-200g', weight: '200g', price: 8, inStock: true },
      { id: 'zobo-500g', weight: '500g', price: 18, inStock: true },
    ],
    featured: true,
  },
  {
    id: 'ogbono-ground-seed',
    name: 'Ogbono Ground Seed',
    category: 'Flours',
    description: 'Finely ground Ogbono (African bush mango) seeds, essential for authentic Nigerian cuisine.',
    usedFor: 'Perfect for making the classic Ogbono soup, known for its unique draw and rich flavor. A must-have for traditional African cooking.',
    images: ['/products/ogbonogroundseed.jpg'],
    variants: [
      { id: 'ogbono-150g', weight: '150g', price: 12, inStock: true },
      { id: 'ogbono-300g', weight: '300g', price: 22, inStock: true },
    ],
    featured: true,
  },
  {
    id: 'grinded-crayfish',
    name: 'Grinded Crayfish',
    category: 'Seafood/Fish',
    description: 'Premium quality dried and ground crayfish, a cornerstone of authentic West African cuisine.',
    usedFor: 'Essential seasoning for soups, stews, jollof rice, and traditional dishes. Adds rich umami flavor and seafood depth.',
    images: ['/products/grindedcrayfish.jpg'],
    variants: [
      { id: 'crayfish-200g', weight: '200g', price: 15, inStock: true },
      { id: 'crayfish-500g', weight: '500g', price: 35, inStock: true },
...
export const sophiaTracks: Track[] = [
  {
    id: 'track-1',
    title: 'Happy',
    coverImage: 'https://img.youtube.com/vi/5pBwHRNWKag/maxresdefault.jpg',
    audioUrl: 'https://youtu.be/5pBwHRNWKag',
    duration: '3:12',
  },
  {
    id: 'track-2',
    title: 'How Will I Know?',
    coverImage: 'https://img.youtube.com/vi/iUs_xWSEd4k/maxresdefault.jpg',
    audioUrl: 'https://youtu.be/iUs_xWSEd4k',
    duration: '3:11',
  },
];
