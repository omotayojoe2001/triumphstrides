...
export function HomePage() {
  ...
  const categories = [
    ...
    { title: 'Event Catering', href: '/services', image: '/products/grindedcrayfish.jpg' },
    { title: 'Daycare (0-4)', href: '/services', image: '/products/fufu.jpg' },
    { title: 'Ranch Services', href: '/services', image: '/products/plantainflour.jpg' },
    { title: 'Cleaning', href: '/services', image: '/products/organicwheatflour.jpg' },
    { title: 'Event Planning', href: '/services', image: '/products/driedzobo.jpg' },
    { title: 'Sophia Music', href: '/sophia-music', image: '/products/ogbonogroundseed.jpg' },
  ];
